...
courses_clean |> 
  ...
  group_by(dept) |> 
  summarize(avg_name_length = mean(title_length)) |> 
...
This activity seems to have cleared up a lot of the prior confusion I was feeling about strings. It also helped me practice my wrangling and using a lot of the previous concepts together which I enjoyed. I feel like I am starting to get the hang of some of the new concepts which is exciting. I hope to keep building on this momentum with the next few exercises. 
