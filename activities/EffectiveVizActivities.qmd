...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temp at 9 am", y = "Temp at 3 pm", title = "9 am to 3pm Temperature Change by Location", color = "Location")  
```
...
```{r}
#| fig-cap: "The relationship between temperature at 9 am and the temperature at 3 pm in Hobart, Uluru, and Wollongong"
...
```{r}
#| fig-cap: "Density plots of 3pm temperatures in 3 Australian locations."
#| fig-alt: "A density plot of temperatures at 3pm in Wollongong, Hobart, and Uluru. The plot indicates that temperature is hottest in Uluru and coldest in Hobart."
