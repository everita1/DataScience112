...
**They are not in order from lowest to highest or vice-versa**
...
It won't order the categories from low to high as accurately as we want. Instead, it will order them from lowest to highest based on the individual difference in support. 
...
This reading was very straightforward. It didn't seem to add in very much new information, *but* the information was important to how easily we will be able to read the data when visualizing. 
